...
def view_TCs(request,id):
    if 'email' in request.session and 'id' in request.session:
        ...
        try:
            ...
            for o in obj:
                print(str(obj.tester_portal) + " " str(obj.tester_portal) + " " str(obj.tester_portal) + " " str(obj.tester_portal) + " " str(obj.tester_portal) + " " str(obj.tester_portal) + " " str(obj.tester_portal) + " ")
