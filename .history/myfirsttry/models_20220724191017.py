...
class TestCase(models.Model):
    ...
    tester_portal = models.ForeignKey(User,on_delete=models.CASCADE,related_name=)
    tester_rm = models.ForeignKey(User,on_delete=models.CASCADE)
    tester_internal = models.ForeignKey(User,on_delete=models.CASCADE)
    tester_be = models.ForeignKey(User,on_delete=models.CASCADE)
    tester_ios = models.ForeignKey(User,on_delete=models.CASCADE)
    tester_android = models.ForeignKey(User,on_delete=models.CASCADE)
    tester_automation = models.ForeignKey(User,on_delete=models.CASCADE)
    tester_comment = models.TextField()
    reviewer_comment = models.TextField()
    tc_author = models.ForeignKey(User,on_delete=models.CASCADE)