...
def view_TCs(request,id):
    if 'email' in request.session and 'id' in request.session:
        ...
        try:
            ...
            for o in obj:
                print(" hello --------------------- " + str(o.tester_portal) + " " str(o.tester_rm) + " " str(o.tester_internal) + " " str(o.tester_be) + " " str(o.tester_ios) + " " str(o.tester_android) + " " str(o.tester_automation) + " ")
                print("try"," " + str(o.tester_portal) + " " str(o.tester_rm) + " " str(o.tester_internal) + " " str(o.tester_be) + " " str(o.tester_ios) + " " str(o.tester_android) + " " str(o.tester_automation) + " ")
