    ...
    if 'email' in request.session and 'id' in request.session:
        ...
        if request.method == 'POST':
            ...
            for obj in objs:
                ...
                if obj.ts_rm == test_status and obj.tester_portal != None and obj.tester_rm.uname == tester:
                    rm = True

                if obj.ts_internal == test_status and obj.tester_portal != None and obj.tester_internal.uname == tester:
                    internal = True
