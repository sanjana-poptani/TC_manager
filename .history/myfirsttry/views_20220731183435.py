...
def view_TCs(request,id):
    if 'email' in request.session and 'id' in request.session:
        ...
        try:
            ...
            for o in obj:
                print(" " + str(o.tester_portal) + " " str(obj.tester_rm) + " " str(obj.tester_internal) + " " str(obj.tester_be) + " " str(obj.tester_ios) + " " str(obj.tester_android) + " " str(obj.tester_automation) + " ")
