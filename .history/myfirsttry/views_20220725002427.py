...
def add_TC(request,id):
    if 'email' in request.session and 'id' in request.session:
        ...
        if request.method == 'GET':
            ...
            new_obj = TestCase.objects.create(usecase = ucase,steps = steps,expected_result = eresult,ts_portal = ts_portal,ts_rm = ts_rm,ts_internal = ts_internal,ts_be = ts_be,ts)
