...
class TestCase_Title(models.Model):
    ...
    scope_id = models.ForeignKey(Scope,on_delete = models.CASCADE,blank=True,null=True)
...
class TestCase(models.Model):
    ...
    tester_automation = models.ForeignKey(User,on_delete=models.CASCADE,related_name='tester_automation',blank=True,null=True)
